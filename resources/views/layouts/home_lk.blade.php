				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							<input name="sender" type="text" class="form-control" id="usr1" placeholder="Отправитель">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<input name="lol1" type="text" class="form-control" id="address1" placeholder="Откуда">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<input name="phone1" type="phone" class="form-control" id="phone1" placeholder="Телефон">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<input name="taker" type="text" class="form-control" id="usr2" placeholder="Получатель">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<input name="lol2" type="text" class="form-control" id="address2" placeholder="Куда">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<input name="phone2" type="phone" class="form-control" id="phone2" placeholder="Телефон">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<select name="type" class="form-control" id="transport">
					...
					<div class="col-md-6">
						<div class="form-group">
							<input name="am" type="text" class="form-control" id="quantity" placeholder="Количество">
						</div>
					</div>
					<div class="col-md-12">
